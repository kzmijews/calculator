/********************************************************************************
** Form generated from reading UI file 'calculatoriUumMY.ui'
**
...
#ifndef CALCULATORIUUMMY_H
#define CALCULATORIUUMMY_H
...
"color: rgb(29, 255, 0);"));
        ...
        letfParenButton = new QPushButton(centralwidget);
        letfParenButton->setObjectName("letfParenButton");
        sizePolicy1.setHeightForWidth(letfParenButton->sizePolicy().hasHeightForWidth());
        letfParenButton->setSizePolicy(sizePolicy1);
        letfParenButton->setMinimumSize(QSize(30, 30));
        letfParenButton->setFont(font);
        letfParenButton->setStyleSheet(QString::fromUtf8("background-color:rgb(26, 95, 180);"));

        keyboardLayout->addWidget(letfParenButton, 1, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *CalculatorMainWindow)
    {
        ...
        letfParenButton->setText(QCoreApplication::translate("CalculatorMainWindow", "(", nullptr));
